...
..  important:: The IMU and memory monitor features of this plugin require :ref:`Open Ephys GUI 1.0.0-alpha.4 <versions>` or later
...
..  note:: 
    -   Plugging two headstage into one port requires a `dual headstage adapter <https://open-ephys.github.io/acq-board-docs/Hardware-Guide/Cables.html#dual-headstage-adapter>`__
    -   The IMU feature is only compatible with the Acquisition Board Gen3
